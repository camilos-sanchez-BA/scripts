...
export async function processProject(
  ...
  try {
    ...
    const newBranchName = `${GIT_BRANCH_PREFIX}`; // Sanitize branch name
    ...
    console.log(
      `  Example: \`gh pr create --base main --head ${newBranchName} --title "${PR_TITLE_PREFIX}" --body "${GIT_COMMIT_MESSAGE}"\``
    );
